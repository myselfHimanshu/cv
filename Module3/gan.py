...
#(scaling, tensor conversion, normalization)
...
#Defining the weights init function
def weights_init(m):
...
for epoch in range(25):
    for i, data in enumerate(dataloader, 0):
        ...
        #Training the discriminator with the real image of the dataset
        real, _ = data
        input = Variable(real)
        ...
        #Training the discriminator with the fake image generated by the generator
